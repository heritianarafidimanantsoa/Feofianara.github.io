...
const maxPan = new THREE.Vector3(4, 7, 7); // Limite maximum de déplacement (droite, haut)
...
function loadModel(file, overideMaterial = null) {
    loader1.load(file, async function (gltf) {
        ...
        // Appliquer la rotation initiale pour changer l'orientation de l'objet
        model.rotation.set(0, Math.PI / -5, 0); // Rotation de 45° autour de l'axe Y
...
function init() {
    ...
    loader1.load("public/Trano.glb", async function (gltf) {
        ...
        // Appliquer la rotation initiale pour orienter les bâtiments
        buildings.rotation.set(0, Math.PI / -5, 0); // Rotation de 45° autour de l'axe Y    
    ...
    loader1.load("/Lalana.glb", async function (gltf) {
        ...
        // Appliquer la rotation initiale pour changer l'orientation de l'objet
        roads.rotation.set(0, Math.PI / -5, 0); // Rotation de 45° autour de l'axe Y
